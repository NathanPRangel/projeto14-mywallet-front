...
import { transfersPostUrl } from "./apiUrls"
...
export default function Home() {
    ...
    return (
        <Container>
            <TopBar>
                <Welcome data-test="user-name">Olá, {userData.user.name}</Welcome>
                <Link to={"/"} style={{ textDecoration: 'none' }}>
                    <ExitImg data-test="logout" src={exit} />
                </Link>
            </TopBar>
            <Content>
                ...
                <BalanceDiv>
                    ...
                    <InfoPrice data-test="total-amount" color={valueColor(balance)}>{balance}</InfoPrice>
                </BalanceDiv>
            </Content>
            <BottomBar>
...
function RenderRegister(register) {
    ...
    return (
        <InfoBox>
            <InfoInfoDateBox >
            <InfoDate data-test="registry-name">{register.date}</InfoDate>
            <Info data-test="registry-name" >{register.description}</Info>
            </InfoInfoDateBox>
            
            <InfoPrice data-test="registry-amount" color={color}>{register.value}</InfoPrice>
        </InfoBox>
    )
}
